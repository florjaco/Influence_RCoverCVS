...
function [P,V,Qentrada,Qsalida,T]=Simulacion_cardiac_chamber2
%le paso Vinicial en m^3, la condicion inicial para la ODE
%tambien le paso Tf, es decir cuanto tiempo quiero simular
%% en este caso estoy simulando un modelo de single chamber (ventrículo derecho) con inercia, uso las ctes que usa el autor en su tesis doctoral (tabla 5.1)
...
L1=1.3*10^4; %inertancia de la válvula tricúspide [Ns/m^5]
R2=1*10^6;%resistencia de la válvula de la arteria pulmonar [Ns^2/m^5]
L2=2*10^4; %inertancia de la válvula de la arteria pulmonar [Ns^2/m^5]
